...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
    ...
    @script(description='Speak shouldAllow', gestures=['kb:NVDA+Home'])
    def script_shouldAllow(self, gesture):
        focus = api.getFocusObject()
        if focus.shouldAllowUIAFocusEvent:
            ui.message(f"Allows focus! {focus.basicText}")
        else:
            ui.message(f"Blocks focus! {focus.basicText}")
