...
def initialize() -> None:
	state = SoundSplitState(config.conf["tonysEnhancements"]["soundSplitState"])
...
def _toggleSoundSplitState() -> None:
	state = SoundSplitState(config.conf["tonysEnhancements"]["soundSplitState"])
	allowedStates: list[int] = config.conf["tonysEnhancements"]["includedSoundSplitModes"]
	try:
	...
	config.conf["tonysEnhancements"]["soundSplitState"] = newState.value
